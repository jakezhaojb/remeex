rootdir = '../results'
experiment_name = 'experiment3_voicing'
resume = true
device = 3
batchSize=100
trainParams = {}
...
--params['LSTM_1lp_200n_20kL_ADA'] = {['model']='LSTM',['peepholes']=true,['dropout']=0,['kL']=20,['kR']=0,['layers']=1,['rnn_size']=200}
--params['LSTM_1l_200n_20kL_ADA_norm'] = {['model']='LSTM',['peepholes']=false,['dropout']=0,['kL']=20,['kR']=0,['layers']=1,['rnn_size']=200,['normalize']=true}
--params['LSTM_1l_200n_20kL_ADA_normSTD'] = {['model']='LSTM',['peepholes']=false,['dropout']=0,['kL']=20,['kR']=0,['layers']=1,['rnn_size']=200,['normalize']=true,['normalizeSTD']=true}
params['LSTM_1lp_200n_40kL_ADA'] = {['model']='LSTM',['peepholes']=true,['dropout']=0,['kL']=40,['kR']=0,['layers']=1,['rnn_size']=200}
