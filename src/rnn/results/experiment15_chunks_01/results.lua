...
results_folder = 'results/melody_LSTM_3l_200n_40kL_b100'

modelfile = paths.concat(results_folder,'model.net')
...
function grabSongData(s)
    ...
    local cqt = VALIDATION.batchCQT[song]
    local melody = VALIDATION.batchMELODY[song]
...
for s = 1,numsongs do
   ...
   os.execute('mkdir -p ' .. paths.concat(predictionDIR,song))
