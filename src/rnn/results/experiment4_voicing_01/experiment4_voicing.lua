rootdir = '../results'
experiment_name = 'experiment4_voicing'
resume = true
device = 2
batchSize=100
trainParams = {}
...
--params['LSTM_1lp_200n_20kL_ADA_normSTD'] = {['model']='LSTM',['peepholes']=true,['dropout']=0,['kL']=20,['kR']=0,['layers']=1,['rnn_size']=200,['normalize']=true,['normalizeSTD']=true}
--params['LSTM_1l_200n_20kL_ADA_normSTD'] = {['model']='LSTM',['peepholes']=true,['dropout']=0,['kL']=20,['kR']=0,['layers']=1,['rnn_size']=200,['normalize']=true,['normalizeSTD']=true}

--params['LSTM_1lp_200n_20kL_SGD_normSTD'] = {['model']='LSTM',['peepholes']=true,['dropout']=0,['kL']=20,['kR']=0,['layers']=1,['rnn_size']=200,['normalize']=true,['normalizeSTD']=true}
--params['LSTM_1l_200n_20kL_SGD_normSTD'] = {['model']='LSTM',['peepholes']=false,['dropout']=0,['kL']=20,['kR']=0,['layers']=1,['rnn_size']=200,['normalize']=true,['normalizeSTD']=true}
--params['LSTM_1l_200n_20kL_SGD_normSTD_avgBPTT'] = {['model']='LSTM',['peepholes']=false,['dropout']=0,['avgBPTT']=true,['kL']=20,['kR']=0,['layers']=1,['rnn_size']=200,['normalize']=true,['normalizeSTD']=true}
params['LSTM_1l_200n_40kL_SGD_normSTD_avgBPTT'] = {['model']='LSTM',['peepholes']=false,['dropout']=0,['avgBPTT']=true,['kL']=40,['kR']=0,['layers']=1,['rnn_size']=200,['normalize']=true,['normalizeSTD']=true}
